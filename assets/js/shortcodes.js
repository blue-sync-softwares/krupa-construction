    ...
    var googleMap = function () {
                ...
                .gmap3({
                    map: {
                        options: {
                            ...
                            mapTypeId: 'Krupa Construction',
                            mapTypeControlOptions: {
                                mapTypeIds: ['Krupa Construction', google.maps.MapTypeId.SATELLITE, google.maps.MapTypeId.HYBRID]
                            },
                            scrollwheel: true
                        },
                    },
        ...
        $.each(data, function (key, val) {
            $('.themesflat-map').gmap3({
                ...
                styledmaptype: {
                    id: "Krupa Construction",
                    options: {
                        name: "Krupa Construction"
                    },
                    styles: [
                        {
